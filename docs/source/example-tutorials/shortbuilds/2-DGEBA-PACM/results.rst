...
The :ref:`results section of the polystyrene tutorial <ps_results>` does a good job walking you through the project directory structure for any ``htpolynet`` run, so we'll skip that here.  
